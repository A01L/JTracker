		...
		<div class="card-body card_color-bg">
			<div class="d-flex flex-column flex-xl-row justify-content-xl-between mb-2">
				<div class="mb-4 mb-xl-0">
					...
					<p class="font-14">Все данные за все время. Обновление: <span class="full-date ml-2"><?php echo date("Y-m-d H:i:s");  ?></span></p>
				</div>
		...
		<div class="table-responsive">
			...
			<div class="product-statistics">
				...
				<div class="statistic-row">
					...
					<div><?php 
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `device` = 'Phone'");
						$num_rows = mysqli_num_rows($result);
						echo $num_rows;
					 ?></div>
					<div><?php 
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `device` = 'Tablet'");
						$num_rows = mysqli_num_rows($result);
						echo $num_rows;
					 ?></div>
					 <div><?php 
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `device` = 'PC'");
						$num_rows = mysqli_num_rows($result);
						echo $num_rows;
					 ?></div>
					<div><?php 
			...
			<div style="background: gray; width: 100%; height: 3px;"></div>
				...
				<div class="statistic-row">
					...
					<div><?php 
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `os` = 'IOS'");
						$num_rows = mysqli_num_rows($result);
						echo $num_rows;
					 ?></div>
					<div><?php 
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `os` = 'AOS'");
						$num_rows = mysqli_num_rows($result);
						echo $num_rows;
					 ?></div>
					 <div><?php 
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `os` = 'Windows OS'");
						$num_rows = mysqli_num_rows($result);
						echo $num_rows;
					 ?></div>
					<div><?php 
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `os` = 'BB'");
						$num_rows = mysqli_num_rows($result);
						echo $num_rows;
					 ?></div>
					<div><?php 
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `os` = 'WEOS'");
						$num_rows = mysqli_num_rows($result);
						echo $num_rows;
					 ?></div>
				</div>
				...
				<div class="statistic-row">
					...
					<div><?php 
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `model_device` = 'iPhone'");
						$num_rows = mysqli_num_rows($result);
						echo $num_rows;
					 ?></div>
					<div><?php 
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `model_device` = 'Samsung'");
						$num_rows = mysqli_num_rows($result);
						echo $num_rows;
					 ?></div>
					 <div><?php 
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `model_device` = 'BB'");
						$num_rows = mysqli_num_rows($result);
						echo $num_rows;
					 ?></div>
					<div><?php 
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `model_device` = 'Sony'");
						$num_rows = mysqli_num_rows($result);
						echo $num_rows;
					 ?></div>
					<div><?php 
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `model_device` = 'null'");
						$num_rows = mysqli_num_rows($result);
						echo $num_rows;
					 ?></div>
				</div>
<br>
				...
				<div class="d-flex justify-content-between align-items-center"><div class="browser-name">Смартфоны</div><div class="using-rate">
					<?php 
						...
						$result = round((100/$all)*$coll_phone);
						echo $result;
					 ?>%
				</div></div>
				<div style="background: #50C878; width: <?php echo $result+1; ?>%; height: 3px;"></div>
				...
				<div class="d-flex justify-content-between align-items-center"><div class="browser-name">Планшеты</div><div class="using-rate"><?php 
						...
						$result = round((100/$all)*$coll_tablet);
				...
				<div class="card" style="float: right; width: 49%;">
					<div class="card-body">
						...
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `browser` = 'Chrome'");
						$coll_res = mysqli_num_rows($result);
						$result = round((100/$all)*$coll_res);
					 ...
					 <div style="background: #50C878; width: <?php echo $result+1; ?>%; height: 3px;"></div>
						...
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `browser` = 'Firefox'");
						$coll_res = mysqli_num_rows($result);
						$result = round((100/$all)*$coll_res);
						echo round((100/$all)*$coll_res);
					 ?>%</div></div>
					 <div style="background: #50C878; width: <?php echo $result+1; ?>%; height: 3px;"></div>
						...
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `browser` = 'Opera'");
						$coll_res = mysqli_num_rows($result);
						$result = round((100/$all)*$coll_res);
						echo round((100/$all)*$coll_res);
					 ?>%</div></div>
						...
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `browser` = 'Yandex'");
						$coll_res = mysqli_num_rows($result);
						$result = round((100/$all)*$coll_res);
						echo round((100/$all)*$coll_res);
					 ?>%</div></div>
						...
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `browser` = 'Safari'");
						$coll_res = mysqli_num_rows($result);
						$result = round((100/$all)*$coll_res);
						echo round((100/$all)*$coll_res);
					 ?>%</div></div>
						...
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `browser` = 'null'");
						$coll_res = mysqli_num_rows($result);
						$result = round((100/$all)*$coll_res);
						echo round((100/$all)*$coll_res);
					 ?>%</div></div>
            ...
            if($result = $conn->query($sql)){
                ...
                foreach($result as $row){
                   ...
                   ?>
						...
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `country` = '$countr'");
						$coll_res = mysqli_num_rows($result);
            ...
            if($result = $conn->query($sql)){
                ...
                foreach($result as $row){
                   ...
                   ?>
						...
						$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `region` = '$countr'");
						$coll_res = mysqli_num_rows($result);
						$results = round((100/$all)*$coll_res);
						echo round((100/$all)*$coll_res);
					 ?>%</div></div>
...
<?php
            ...
            if($result = $conn->query($sql)){
				...
				<tr>
					...
					<td><?php 
					$idr = $row["id"];
					$result = mysqli_query($connect, "SELECT * FROM `data` WHERE `redirect` = '$idr'");
						$num_rows = mysqli_num_rows($result);
						echo $num_rows;
					?></td>
